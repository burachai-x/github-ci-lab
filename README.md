...
| `ci: อย่าให้ artifact...`             | **บทเรียนจากของจริง** — ด่านแดงเพราะอัป artifact ไม่ผ่าน ทั้งที่ผลตรวจผ่าน          |
| `ci(secrets): แยกขอบเขต...`           | **บทเรียนจากของจริง** — `--all` ทำให้ `main` แดงเพราะ branch อื่น                   |
| `ci(container): แยกกรณี build ล้ม...` | **บทเรียนจากของจริง** — รายงานบอกว่า "รันด้วย root" ทั้งที่ build ล้มเพราะเครือข่าย |

ห้า commit ท้ายที่ติดป้าย **บทเรียนจากของจริง** คือของที่มีค่าที่สุดใน repo นี้
เพราะเป็นสิ่งที่เกิดขึ้นจริงเวลาตั้ง pipeline ไม่ใช่ตัวอย่างที่เตรียมมาให้สวยงาม
และสามในห้าข้อเป็นเรื่องเดียวกัน: **CI แดงด้วยเหตุที่ไม่เกี่ยวกับคุณภาพโค้ด**
ซึ่งเป็นสาเหตุอันดับหนึ่งที่ทำให้ทีมเลิกเชื่อถือ pipeline
